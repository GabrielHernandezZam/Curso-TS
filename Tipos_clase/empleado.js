...
var Empleado = /** @class */ (function (_super) {
    ...
    function Empleado(nombre, edad, esDesarrollador, puesto) {
        var _this = _super.call(this, nombre, edad, esDesarrollador) || this; //Llama al constructor de la clase padre
        _this.puesto = puesto; //Llama al constructor de la clase hijo
        return _this;
    }
    ...
    Empleado.prototype.obtenerInfo = function () {
        return "Tengo ".concat(this.obtenerEdad(), " anios y trabajo como ").concat(this.puesto);
    };
    return Empleado;
}(clase_1.Persona));
